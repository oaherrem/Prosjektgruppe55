#Funksjon "is_crosswind" lager et crosswind-område på angitt rullebane med hensyn til hvilken vinkel rullebanen har. 
def is_crosswind(runway_angle, wind_direction, wind_speed):
    
    #Returnerer vinkelen mellom to retninger(0-180°).
    def angle_diff(a, b):
    ...
    # Sjekk hvis rullebanenvinkel eller rullebanevinkel + 180 grader er i det "kritiske intervallet" 45–135° i forhold til x og x komplement
